...
export const getTokens = (theme: Theme): Tokens => {
  ...
  const LIGHT_TONE: Record<string, ToneLevel> = {
    ...
    CONTAINER: 90,
    CONTAINER_ON: 30,
    CONTAINER_ON_HIGH: 15,
    CONTAINER_ON_LOW: 60,
    CONTAINER_ON_SLIGHT: 70,
    CONTAINER_ON_FAINT: 80,
    BG: 98,
    BG_ON: 30,
    BG_ON_HIGH: 0,
    BG_ON_LOW: 60,
  ...
  const DARK_TONE: Record<string, ToneLevel> = {
    ...
    CONTAINER: 30,
    CONTAINER_ON: 90,
    CONTAINER_ON_HIGH: 95,
    CONTAINER_ON_LOW: 70,
    CONTAINER_ON_SLIGHT: 40,
    CONTAINER_ON_FAINT: 35,
    BG: 10,
    BG_ON: 85,
    BG_ON_HIGH: 95,
    BG_ON_LOW: 60,
