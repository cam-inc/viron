...
const Renewal = function <T = null>({
  ...
  return (
    <button
      ...
      className={classnames(
        `flex items-center gap-1 px-3 py-2 active:opacity-50 focus:outline outline-thm-outline border bg-thm-background hover:bg-thm-on-${cs} text-thm-${cs} border-thm-${cs}`,
        {
