      ...
      <div className="relative">
        <div
          ...
          className={classnames(
            `absolute inset-0 pointer-events-none bg-thm-on-${on} group-hover:opacity-75 group-active:opacity-50`,
            {
              rounded: rounded,
            }
          )}
        ...
        <div
          ...
          className={classnames(
            `relative flex items-center gap-1 px-2 py-1 text-thm-${on}`,
            {
