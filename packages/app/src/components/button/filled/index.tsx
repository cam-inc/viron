  ...
  return (
    ...
    >
      <div className="relative">
        <div
          className={`absolute inset-0 pointer-events-none rounded bg-thm-${cs} group-hover:opacity-75 group-active:opacity-50`}
        />
        <div
        ...
        <div
          className={classnames(
            `relative flex items-center gap-1 px-2 py-1 rounded text-thm-on-${cs}`,
            {
