...
import CardListOutlineIcon from '~/components/icon/cardList/outline';
import LayersOutlineIcon from '~/components/icon/layers/outline';
...
const paths: {
...
}[] = [
  {
    ...
    icon: <CardListOutlineIcon className="w-[1.42em] h-[1.42em]" />,
  },
  {
    to: INTERNAL_PAGE_PATHS.GROUPS,
    label: 'internalPagePaths.groups',
    icon: <LayersOutlineIcon className="w-[1.42em] h-[1.42em]" />,
  },
];
