viron-endpoints-page-endpoint-signin-email.EndpointsPage_Endpoint_Signin_Email
  ...
  viron-textinput(placeholder="mail address" val="{ IDまたはメールアドレス }" onChange="{ handleMailAddressChange }")
  viron-textinput(placeholder="パスワード" type="password" val="{ password }" onChange="{ handlePasswordChange }")
