viron-components-page-filter.ComponentsPage_Filter(class="ComponentsPage_Filter--{ layoutType }")
  .ComponentsPage_Filter__head
    .ComponentsPage_Filter__closeButton(onTap="{ handleCloseButtonTap }")
      viron-icon-close
    .ComponentsPage_Filter__title { i18n('viron_components_filter_title') }
    .ComponentsPage_Filter__description { i18n('viron_components_filter_description') }
    .ComponentsPage_Filter__control
      .ComponentsPage_Filter__item
        viron-checkbox(label="{ i18n('viron_components_filter_label') }" isChecked="{ isAllSelected }" theme="ghost" onChange="{ handleAllSelectChange }" )
  ...
  .ComponentsPage_Filter__tail
    viron-button(label="{ i18n('viron_components_filter_button') }" isDisabled="{ isApplyButtonDisabled }" onSelect="{ handleApplyButtonTap }")
