viron-application-order-item.Application__orderItem(draggable="{ true }" onDragStart="{ handleDragStart }" onDrag="{ handleDrag }" onDragEnd="{ handleDragEnd }")
  ...
  script.
    import '../components/atoms/viron-icon/index.tag';
