viron-application-order-droparea.Application__orderDroparea(class="{ 'Application__orderDroparea--watching' : isWatching, 'Application__orderDroparea--droppable' : isDroppable }")
