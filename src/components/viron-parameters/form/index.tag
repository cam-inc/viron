viron-parameters-form.Parameters_Form
  ...
  .Parameters_Form__body
    ...
    virtual(if="{ uiType === 'textinput' }")
      viron-textinput(val="{ opts.val }" theme="{ opts.theme }" isPreview="{ opts.ispreview }" isDisabled="{ opts.isdisabled }" isError="{ hasError }" onChange="{ handleTextinputChange }")
    virtual(if="{ uiType === 'textarea' }")
      viron-textarea(val="{ opts.val }" theme="{ opts.theme }" isPreview="{ opts.ispreview }" isDisabled="{ opts.isdisabled }" isError="{ hasError }" onChange="{ handleTextareaChange }")
    virtual(if="{ uiType === 'numberinput' }")
      viron-numberinput(val="{ opts.val }" theme="{ opts.theme }" isPreview="{ opts.ispreview }" isDisabled="{ opts.isdisabled }" isError="{ hasError }" onChange="{ handleNumberinputChange }")
    ...
    virtual(if="{ uiType === 'html' }")
      viron-html(val="{ opts.val }" theme="{ opts.theme }" isPreview="{ opts.ispreview }" isDisabled="{ opts.isdisabled }" isError="{ hasError }" onChange="{ handleHtmlChange }")
    virtual(if="{ uiType === 'pug' }")
      viron-pug(val="{ opts.val }" theme="{ opts.theme }" isPreview="{ opts.ispreview }" isDisabled="{ opts.isdisabled }" isError="{ hasError }" onChange="{ handlePugChange }")
