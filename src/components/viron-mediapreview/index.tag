viron-mediapreview.Mediapreview(class="{ 'Mediapreview--visible': isVisible, 'Mediapreview--settled': isSettled } Mediapreview--{ opts.mediapreviewopts.theme }" onTap="{ handleTap }")
