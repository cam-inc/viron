viron-dialog.Dialog
  ...
  .Dialog__control
    viron-button(label="{ opts.labelPositive || i18n('compornents_viron_dialog_ok') }" onSelect="{ handlePositiveSelect }")
    viron-button(label="{ opts.labelNegative || i18n('compornents_viron_dialog_cancel') }" theme="ghost" onSelect="{ handleNegativeSelect }")
