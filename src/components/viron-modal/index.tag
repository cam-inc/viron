viron-modal.Modal(class="{ 'Modal--visible': isVisible, 'Modal--hidden': isHidden } Modal--{ opts.modalopts.theme } Modal--{ layoutType } { opts.modalopts.isSpread ? 'Modal--spread': '' } { opts.modalopts.class }" onTap="{ handleTap }")
