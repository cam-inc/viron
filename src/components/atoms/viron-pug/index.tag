viron-pug.Pug
  .Pug__tabs
    .Pug__tab(class="{ 'Pug__tab--selected' : isTabEditorSelected }" onClick="{ handleTabEditorClick }") editor
    .Pug__tab(class="{ 'Pug__tab--selected' : isTabPreviewSelected }" onClick="{ handleTabPreviewClick }") preview
  .Pug__body
