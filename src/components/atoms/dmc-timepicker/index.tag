dmc-timepicker.Timepicker
    ...
    .Timepicker__partialTime(if="{ opts.isshown }")
      .Timepicker__partialTimeBody
        .Timepicker__partialTimeList.Timepicker__partialTimeList--left(ref="hourlist")
        ...
        .Timepicker__partialTimeList.Timepicker__partialTimeList--center(ref="minutelist")
        ...
        .Timepicker__partialTimeList.Timepicker__partialTimeList--right(ref="secondlist")
