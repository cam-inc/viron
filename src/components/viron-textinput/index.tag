viron-textinput.Textinput(ref="textinput" class="{ 'Textinput--disabled': opts.isdisabled, 'Textinput--preview': opts.ispreview, 'Textinput--error': opts.iserror } Textinput--{ opts.theme }" onTap="{ handleTap }")
